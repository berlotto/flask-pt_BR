...
Bem vindo a documentação do Flask. Esta documentação está dividida em diferentes partes.
...
-   `Documentação Jinja2 <http://jinja.pocoo.org/2/documentation/>`_
-   `Documentação Werkzeug <http://werkzeug.pocoo.org/documentation/>`_
